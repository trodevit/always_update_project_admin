...
class SuggestionController extends Controller
{
    ...
    {
        $suggestions = Suggestion::where('class_name','SSC')->where('types','suggestion')->get();
        return view('SSC.suggestion.index',['suggestions'=>$suggestions]);
    }
    ...
    {
        return view('SSC.suggestion.create');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('SSC.suggestion.edit',['upload'=>$upload]);
    }
