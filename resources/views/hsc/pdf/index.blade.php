    ...
    <div class="container mt-5">
        ...
        <table class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('hsc.pdf.edit', $course->id) }}" class="btn btn-sm btn-primary">Edit</a>
                    <form id="delete-form-{{ $course->id }}" action="{{ route('hsc.pdf.destroy', $course->id) }}" method="POST" style="display:inline;">
                        @csrf
                        @method('DELETE')
