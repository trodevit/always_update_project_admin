    ...
    <div class="container mt-5">
        ...
        <table class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('hsc.shortcut.edit', $course->id) }}" class="btn btn-sm btn-primary">Edit</a>
                    <form id="delete-form-{{ $course->id }}" action="{{ route('hsc.shortcut.destroy', $course->id) }}" method="POST" style="display:inline;">
                        @csrf
                        @method('DELETE')
