                            ...
                            <form action="{{route('course.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" name="short_description" value="{{old('short_description')}}" placeholder="(e.g., SSC, HSC, BSc)" id="example-text-input">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" name="video_link" value="{{old('video_link')}}" placeholder="(e.g., SSC, HSC, BSc)" id="example-text-input">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
