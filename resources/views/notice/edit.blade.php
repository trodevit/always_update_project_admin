...
@section('content')
    <div class="container mt-5">
        ...
        <form action="{{route('notice.update',$upload->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="video_link" name="official_url" value="{{ $upload->official_url }}" placeholder="Enter video URL" required>
            </div>
