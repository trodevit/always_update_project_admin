                        ...
                        <div class="row">
                            <form action="{{route('common.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3 row">
                                        <div class="col-sm-10">
                                            <input class="form-control" type="hidden" name="check" value="scholarship" id="example-text-input">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3 row">
                                        <div class="col-sm-10">
                                            ...
                                            <a class="btn btn-info" href="{{route('scholarship.index')}}" id="example-search-input">
                                                Show All Data
                                            </a>
                                        </div>
                                    </div>
