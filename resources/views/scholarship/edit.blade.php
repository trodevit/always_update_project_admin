            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <div class="row">
                            <form action="{{route('common.update',['type'=>$common->check,'id'=>$common->id])}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="col-lg-6">
                                    <div class="mb-3 row">
                                        <div class="col-sm-10">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" name="description" value="{{old('description',$common->description)}}" id="example-text-input">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
